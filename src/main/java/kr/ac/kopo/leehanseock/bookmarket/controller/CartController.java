...
import kr.ac.kopo.leehanseock.bookmarket.domain.CartItem;
...
import kr.ac.kopo.leehanseock.bookmarket.service.CartService;
...
public class CartController {
    ...
    public @ResponseBody Cart create(@RequestBody Cart cart) {
        System.out.println("Call create() with cartId: " + cart.getCartId());
        return cartService.create(cart);
    }

    @GetMapping("/{cartId}")
    public String requestCart(@PathVariable(value="cartId") String cartId, Model model){
    ...
    public void addCardByNewItem(@PathVariable("bookId") String bookId, HttpServletRequest request) {
